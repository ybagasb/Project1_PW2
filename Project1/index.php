    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div class="mx-5">
                <h2 class="text-center my-4">Form Pasien BMI</h2><hr><br>
                <form method="GET" action="BMIPasien.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="kd_pasien" name="kd_pasien" placeholder="PS" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nama_pasien" class="col-4 col-form-label">Nama Lengkap</label> 
                        <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                    ...
                    <div class="form-group row">
                        <label for="brt_pasien" class="col-4 col-form-label">Berat Badan</label> 
                        <div class="col-8">
                        <div class="input-group">
                            <input id="brt_pasien" name="brt_pasien" type="text" class="form-control"> 
                            <div class="input-group-append">
                    ...
                    <div class="form-group row">
                        <label for="tgi_pasien" class="col-4 col-form-label">Tinggi Badan</label> 
                        <div class="col-8">
                        <div class="input-group">
                            <input id="tgi_pasien" name="tgi_pasien" type="text" class="form-control"> 
                            <div class="input-group-append">
